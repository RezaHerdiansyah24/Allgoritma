...
const EditContactUs = () => {
    ...
    const getContactUsById = async () => {
        const response = await axios.get(`http://localhost:5000/contactus/${id}`);
  ...
  return (
    <div className="list">
      ...
      <div className="listContainer">
        <Navbar/>
        <div className="title mt-5"><h1>Update Contact Us</h1></div>
            <div className="columns mt-5 is-centered">
                <div className="column is-half">
                    <form onSubmit={updateContactUs}>
                        <div className="field">
